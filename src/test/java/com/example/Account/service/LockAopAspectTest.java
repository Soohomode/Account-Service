...
class LockAopAspectTest {
    ...
    @Test
    void lockAndUnlock() throws Throwable { // lock 이 잘 작동하고 unlock 이 잘 작동하는지 테스트
        //given
    ...
    @Test
    void lockAndUnlock_evenIfThrow() throws Throwable { // lock 이 잘 작동하고 unlock 이 잘 작동하는지 테스트
        //given
        ArgumentCaptor<String> lockArgumentCaptor = ArgumentCaptor.forClass(String.class);
        ArgumentCaptor<String> unlockArgumentCaptor = ArgumentCaptor.forClass(String.class);
